...
using starwarsapi2Service.DataObjects;
using starwarsapi2Service.Models;
using Owin;
...
namespace starwarsapi2Service
{
    public partial class Startup
    {
        public static void ConfigureMobileApp(IAppBuilder app)
        {
            ...
            Database.SetInitializer(new starwarsapi2Initializer());
    ...
    public class starwarsapi2Initializer : CreateDatabaseIfNotExists<starwarsapi2Context>
    {
        protected override void Seed(starwarsapi2Context context)
        {
